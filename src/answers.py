...
class Answers:
    ...
    val_fail = '❌ Проверка не пройдена. Удостоверьтесь что вы состоите в профсоюзе и правильно ввели данные.' \
               '\n\nВведите фамилию и номер профсоюзного билета в формате:'
    val_fail_format = 'Я вас не понимаю. Если вы хотите обновить данные авторизации введите фамилию и ' \
                      'номер профсоюзного билета в формате:'
    val_unknown_message = 'Сообщение не распознано. Если вы хотите обновить данные авторизации введите фамилию и ' \
                          'номер профсоюзного билета в формате:'
