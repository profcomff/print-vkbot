...
kb_ans = {
    ...
    'conf_full': 'Файлы, которые вы отправляете через бота будут храниться в течение не менее 7 дней на хостингах '
                 'в Финляндии и Нидерландах, а также в этом чате ВК.\n'
